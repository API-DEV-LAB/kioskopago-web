...
export const formatPrice = (amount: number | string | undefined): string => formatCurrency(amount)
...
export function getDateNow(): string {
  return new Intl.DateTimeFormat('es-MX', { dateStyle: 'medium', timeStyle: 'short' }).format(new Date())
}
