				...
				<div className="grid md:grid-cols-3 gap-8">
					<div className="bg-card rounded-lg p-6 space-y-4 border shadow-sm">
						...
						<p className="text-muted-foreground leading-relaxed">
							...
							formularios largos ni complicaciones. En menos de 1
							minuto ya estarás usando la plataforma.
						</p>
					</div>
					<div className="bg-card rounded-lg p-6 space-y-4 border shadow-sm">
						...
						<p className="text-muted-foreground leading-relaxed">
							...
							bancario. Guarda tus tarjetas de forma segura para
							pagos más rápidos.
						</p>
					</div>
					<div className="bg-card rounded-lg p-6 space-y-4 border shadow-sm">
						...
						<p className="text-muted-foreground leading-relaxed">
							¿Necesitas ayuda? Nuestro equipo está disponible por
							WhatsApp para resolver todas tus dudas al instante.
						</p>
					</div>
				</div>
			</div>
