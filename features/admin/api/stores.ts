...
export async function listStores(params?: { page?: number; limit?: number; search?: string }): Promise<ListStoresResponse> {
...
export async function updateStore(id: string, data: UpdateStoreDto): Promise<Store> {
